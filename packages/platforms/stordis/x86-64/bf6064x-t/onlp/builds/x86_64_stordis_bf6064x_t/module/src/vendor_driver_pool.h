...
typedef struct i2c_bus_driver_s
{
    ...
    int (*block_read)(int bus, uint8_t dev, uint16_t daddr, uint8_t *ReplyBuf, uint8_t BufSize);
    int (*block_write)(int bus, uint8_t dev, uint16_t daddr, uint8_t *value, uint8_t BufSize);
